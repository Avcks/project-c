...
void checkout() {
    ...
    if (payChoice == 2) {
        system("cls");
        printHeader("AYH MART  |  QR PAYMENT");
        printf("\n  Opening QR Code for scanning...\n");
        printf("\n  ┌──────────────────────────────────────────┐\n");
        printf("  │  UPI ID  : 6353999107@ptyes             │\n");
        printf("  │  Name    : Dhameliya Yash Mukeshbhai    │\n");
        printf("  │  Amount  : Rs. %-8.2f                 │\n", finalAmount);
        printf("  └──────────────────────────────────────────┘\n");
        printf("\n  [*] Scan the QR image that just opened.\n");
        printf("  [*] Pay Rs. %.2f and press any key once done.\n\n", finalAmount);
        system("start qr_code.jpeg");
        totalQRPayments++;
