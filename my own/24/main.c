...
int ad_user_hash = 193488787;
int ad_pass_hash = 193488787;
int sf_user_hash = 193500721;
int sf_pass_hash = 193500721;
...
void login() {
    ...
    int uHash = djb2Hash(username);
    int pHash = djb2Hash(password);
